...
exports.initBuildOptions = exports.buildSSR = exports.build = exports.buildByVite = void 0;
...
async function build(options, callback) {
    ...
    const watcher = await buildByVite((0, utils_1.addConfigFile)(initBuildOptions(options, (0, utils_1.cleanOptions)(options))));
...
async function buildApp(options, callback) {
    if (options.manifest) {
