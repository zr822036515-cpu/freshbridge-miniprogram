...
function transformVModel(props, node, context, { isComponent, binding, event, formatEventCode, }) {
    ...
    const vOnValue = (onUpdateExpr.type === compiler_core_1.NodeTypes.JS_CACHE_EXPRESSION
        ? onUpdateExpr.value
        : onUpdateExpr);
    let vOnExpr = (0, vOn_1.wrapperVOn)(modifiers
    ...
    vOnExpr = formatEventCode((0, codegen_1.genExpr)(vOnExpr));
    if (rawVOnExpr) {
        vOnExpr = (0, compiler_core_1.createSimpleExpression)(vOnExpr, false);
        // @ts-expect-error
        vOnExpr.__withoutKeysVOnExpr = formatEventCode((0, codegen_1.genExpr)(rawVOnExpr));
    }
    const vOnUpdate = (0, uni_cli_shared_1.createOnDirectiveNode)(event || (0, shared_1.camelize)(onUpdateArg.content.replace('onUpdate:', 'update-')), vOnExpr);
