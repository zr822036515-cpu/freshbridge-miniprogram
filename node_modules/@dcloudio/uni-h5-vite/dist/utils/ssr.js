    ...
    if (process.env.UNI_APP_X === 'true') {
        ...
        fs_1.default.readFileSync = (...args) => {
            ...
            if (shouldRedirectToDistX) {
                ...
                const distDir = (0, utils_1.resolveDistDir)() + '/';
                if (pkgData.module) {
...
function rewriteSsrVue() {
    ...
    require('module-alias').addAliases({
        vue: (0, uni_cli_shared_1.resolveBuiltIn)('@dcloudio/uni-h5-vue/' + (0, utils_1.resolveVueDistDir)() + '/vue.runtime.cjs.js'),
...
function rewriteSsrResolve() {
    ...
    resolve.sync = (id, opts) => {
        if (id === 'vue') {
            return (0, uni_cli_shared_1.resolveBuiltIn)('@dcloudio/uni-h5-vue/' + (0, utils_1.resolveVueDistDir)() + '/vue.runtime.cjs.js');
        }
